...
class Layer:
    ...
    def insert_Blank_Keyframe(self, frameIndex):
...
if __name__ == '__main__':
    ...
    # print(xfl.timelines[0].layers[0][1000].startFrame)
    # import time
    # start = time.perf_counter()
    # for i in range(xfl.timelines[0].layers[0].frameCount):
    #     xfl.timelines[0].layers[0].insert_Keyframe(i)
    # end = time.perf_counter()
    # print(f"Inserting {xfl.timelines[0].layers[0].frameCount} keyframes took {end-start} seconds")
