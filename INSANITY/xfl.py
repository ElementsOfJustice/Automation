...
class Timeline:
    ...
    def add_Layer(self, layer_name, layer_color=None):
...
# frames[1] will get second keyframe, layers[14] will get the 14th frame in the laye
class Frame:
...
class SymbolInstance(Element):
    def __init__(self, symbolInstance_element):
        ...
        # self.type = symbolInstance_element.tag.split('}', 1)[-1]
    ...
    # attributes: <DOMSymbolInstance libraryItemName="Symbol 1 copy" selected="true" symbolType="graphic" firstFrame="4" loop="single frame">
    @property
...
if __name__ == '__main__':
    ...
    xfl.timelines[0].get_Layer_From_Name("Layer_1")[0].insert_Blank_Keyframe(14)
