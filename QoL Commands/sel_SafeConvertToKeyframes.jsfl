...
if (delta <= 10) {
    ...
    if(!fl.getDocumentDOM().getTimeline().layers[selectedFrames[0]].frames[selectedFrames[2]].isEmpty)
        fl.getDocumentDOM().selection = fl.getDocumentDOM().getTimeline().layers[selectedFrames[0]].frames[selectedFrames[2]].elements;
} else {
